...
export default function Footer() {
    ...
    return (
        <footer
            ref={footerRef}
            className={`overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] ${isVisible ? 'bg-black text-white mt-auto h-20 flex items-center translate-y-0 opacity-100 pointer-events-auto' : 'bg-transparent border-none h-0 opacity-0 -translate-y-6 pointer-events-none'}`}
        >
            <div className="w-full px-4 max-w-none mx-auto flex justify-between items-center gap-8">
