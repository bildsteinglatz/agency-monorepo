                ...
                {isOpen && (
                    <div key="reader-modal" className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
                        ...
                        <motion.div 
                            ...
                            className="relative w-full max-w-5xl max-h-[90vh] bg-white border-8 border-black shadow-[20px_20px_0px_0px_rgba(255,49,0,1)] flex flex-col overflow-hidden"
                        >
                            {/* Header */}
