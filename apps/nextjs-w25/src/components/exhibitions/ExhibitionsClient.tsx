    ...
    <div className="w-full">
      ...
      <div className={`w-full secondary-navigation sticky top-0 z-[90] bg-background transition-all duration-500 ease-in-out ${retractionLevel >= 3 ? '-translate-y-full opacity-0' : 'translate-y-0 opacity-100'}`}>
        <nav className="second-nav pt-[6px] pb-[7px] relative">
          <div className="nav-container-alignment flex gap-x-[11px] md:gap-x-3 gap-y-1 items-center flex-wrap">
            <button
        ...
        <AnimatePresence>
          {isNearBottom && (
            <>
              ...
              >
                <div className="flex gap-x-[11px] md:gap-x-3 gap-y-1 items-start justify-start flex-wrap font-bold italic uppercase">
                  <button
