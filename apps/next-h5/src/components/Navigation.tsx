            ...
            <div className="w-full px-4 min-h-[4rem]">
                <div className="flex justify-between h-16">
                    <div className="flex w-full justify-between items-center">
                        <Link href="/" className="flex items-center text-white hover:text-[#fdc800] transition-colors group">
                        ...
                        <div className="hidden lg:flex lg:items-center lg:justify-end lg:w-full">
                            <div className="flex items-center gap-[2px]">
                                <Link
                                    href="/visit"
                                    className="group relative inline-flex items-center px-4 h-10 border-2 border-transparent text-sm font-bold uppercase text-white hover:border-[#fdc800] transition-all overflow-hidden"
                                >
                                    ...
                                    <div className="absolute inset-y-0 left-0 hidden group-hover:flex items-center whitespace-nowrap animate-marquee pl-4">
                                        <span className="text-[#fdc800]">HALLE 5 – SPINNERGASSE 1 – 6850 Dornbirn —&nbsp;</span>
                                        <span className="text-[#fdc800]">HALLE 5 – SPINNERGASSE 1 – 6850 Dornbirn —&nbsp;</span>
                                    </div>
                                </Link>
                                ...
                                >
                                    ...
                                    <div className="absolute inset-y-0 left-0 hidden group-hover:flex items-center whitespace-nowrap animate-marquee pl-4">
                                        <span className="text-[#fdc800]">ATELIER FÜR AUẞERGEWÖHNLICHE ANGELEGENHEITEN —&nbsp;</span>
                                        <span className="text-[#fdc800]">ATELIER FÜR AUẞERGEWÖHNLICHE ANGELEGENHEITEN —&nbsp;</span>
                                    </div>
                                </Link>
                                <Link
                                ...
                                >
                                    ...
                                    <div className="absolute inset-y-0 left-0 hidden group-hover:flex items-center whitespace-nowrap animate-marquee pl-4">
                                        <span className="text-[#fdc800]">OFFENES ATELIER FÜR KINDER UND JUGENDLICHE —&nbsp;</span>
                                        <span className="text-[#fdc800]">OFFENES ATELIER FÜR KINDER UND JUGENDLICHE —&nbsp;</span>
                                    </div>
                                </Link>
                                <NavLink href="/workshops">Workshops</NavLink>
                                <NavLink href="/member" className="bg-[#fdc800] text-white hover:bg-white hover:text-black transition-colors uppercase">Jetzt Mitglied werden</NavLink>
                                    ...
                                    {user ? (
                                        <div className="flex items-center gap-2">
                                            <button 
                                                ...
                                                className="inline-flex items-center gap-2 px-4 h-10 border-2 border-transparent text-sm font-bold uppercase text-white hover:border-[#fdc800] hover:text-[#fdc800] transition-all"
                                            >
                                            ...
                                            <button 
                                                onClick={() => logout()}
                                                className="inline-flex items-center justify-center w-10 h-10 border-2 border-transparent text-white hover:border-[#fdc800] hover:text-[#fdc800] transition-all"
                                                title="Abmelden"
                                            >
                                        ...
                                        <button 
                                            ...
                                            className="inline-flex items-center px-4 h-10 border-2 border-transparent text-sm font-bold uppercase text-white hover:border-[#fdc800] hover:text-[#fdc800] transition-all"
                                        >
                                            Anmelden
                                        </button>
                                    )}
                        ...
                        <div className="lg:hidden flex items-center">
                            <button
                                ...
                                className="p-2 border-4 border-white text-white hover:bg-[#fdc800] transition-colors"
                            >
                ...
                <div className={`${isOpen ? 'block' : 'hidden'} lg:hidden bg-black border-t-4 border-[#fdc800] absolute top-16 left-0 w-full z-[100] shadow-[0_20px_50px_rgba(0,0,0,1)] max-h-[calc(100vh-4rem)] overflow-y-auto`}>
                    <div className="flex flex-col p-2 space-y-1">
                        ...
                        <MobileNavLink href="/member" onClick={() => setIsOpen(false)} className="bg-[#fdc800] text-white">Mitglied werden</MobileNavLink>

                        <div className="pt-2 border-t-2 border-[#fdc800]/30 space-y-0.5">
                            <span className="px-2 pb-0.5 block text-[8px] text-[#fdc800] font-black tracking-widest uppercase">Über uns</span>
                            ...
                            <div className="border-t-2 border-[#fdc800]/30 my-1"></div>
                                ...
                                {user ? (
                                    <>
                                        ...
                                        <button 
                                            ...
                                            className="block px-2 py-1 text-xs font-black uppercase text-white border-2 border-transparent hover:border-[#fdc800] hover:bg-white hover:text-black transition-all text-left pl-4 border-l-2 border-l-[#fdc800]"
                                        >
                                            Abmelden
                                        </button>
                                    </>
...
function NavLink({ href, children, className = "" }: { href: string; children: React.ReactNode; className?: string }) {
    return (
        <Link
            href={href}
            prefetch={false}
            className={`inline-flex items-center px-4 h-10 border-2 border-transparent text-sm font-bold uppercase text-white hover:border-[#fdc800] hover:text-[#fdc800] transition-all ${className}`}
        >
            {children}
        </Link>
    );
...
function SubLink({ href, children, className = "" }: { href: string; children: React.ReactNode; className?: string }) {
    return (
        <Link
            href={href}
            prefetch={false}
            className={`block px-4 py-2 text-sm font-bold uppercase text-white hover:bg-[#fdc800] hover:text-white transition-colors ${className}`}
        >
            {children}
        </Link>
    );
...
function MobileNavLink({ href, children, onClick, className = "", isSub = false }: { href: string; children: React.ReactNode; onClick: () => void; className?: string; isSub?: boolean }) {
    return (
        <Link
            ...
            onClick={onClick}
            prefetch={false}
            className={`block px-2 py-1 text-sm font-black uppercase text-white border-2 border-transparent hover:border-[#fdc800] hover:bg-white hover:text-black transition-all ${isSub ? 'text-xs pl-4 border-l-2 border-l-[#fdc800]' : ''} ${className}`}
        >
            {children}
        </Link>
    );
