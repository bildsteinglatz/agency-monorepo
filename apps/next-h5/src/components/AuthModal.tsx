            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-start justify-center p-4 overflow-y-auto pt-12 md:pt-24">
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            className="w-full bg-black text-white py-3 text-lg font-black uppercase hover:bg-[#fdc800] transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-1 active:translate-y-1"
                        >
                            Verstanden
                        </button>
                    </m.div>
