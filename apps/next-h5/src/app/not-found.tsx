    ...
    return (
        <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="max-w-2xl">
                ...
                <Link 
                    href="/"
                    className="inline-block bg-[#FF3100] text-white text-2xl md:text-4xl font-black uppercase px-12 py-6 border-4 border-white shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] hover:translate-x-2 hover:translate-y-2 hover:shadow-none transition-all"
                >
                    Zurück zur Halle 5
                </Link>
            </div>
