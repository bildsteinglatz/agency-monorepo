                            ...
                            <div>
                                ...
                                <div className="p-4 border-4 border-black font-bold uppercase text-black">
                                    {profile.roles.includes('member') ? (
                                        <div className="text-[#FF3100]">Aktives Mitglied — Danke für deinen Support!</div>
                                    ) : (
                        ...
                        <div className="bg-white p-8 border-4 border-black">
                            ...
                            <div className="space-y-2">
                                ...
                                {profile.roles.includes('artist') && (
                                    <button className="w-full text-left p-3 border-2 border-black font-black uppercase text-xs bg-[#FF3100] text-white hover:bg-black transition-colors">
                                        Artist Dashboard
                                    </button>
                                )}
                                {profile.roles.includes('admin') && (
                                    <button className="w-full text-left p-3 border-2 border-black font-black uppercase text-xs bg-black text-white hover:bg-[#FF3100] transition-colors">
                                        Admin Panel
                                    </button>
                                )}
                            </div>
