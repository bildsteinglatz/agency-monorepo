...
const portableTextComponents = {
  block: {
    normal: ({children}: any) => <p className="mb-4 text-black dark:text-black leading-relaxed">{children}</p>,
    ...
    blockquote: ({children}: any) => (
      <blockquote className="border-l-4 border-orange-500 pl-4 my-6 italic text-black dark:text-black">
        {children}
      </blockquote>
    ),
  },
  ...
  listItem: {
    bullet: ({children}: any) => <li className="text-black dark:text-black">{children}</li>,
    number: ({children}: any) => <li className="text-black dark:text-black">{children}</li>,
  },
}
  ...
  return (
    <div className="prose prose dark:prose-invert max-w-none">
      ...
      {exhibition.text && exhibition.text.length > 0 ? (
        ...
        <div>
          <h2 className="text-2xl font-semibold title-text mb-6">About this Exhibition</h2>
          <div className="bg-white dark:bg-white rounded-lg p-6 text-center text-black dark:text-black">
