        ...
        <div className="w-full relative">
          <nav className="flex items-center pt-[6px] pb-[12px] md:pb-[38px] relative">
            ...
            <div className="nav-container-alignment">
              ...
              >
                {/* Left Group */}
                <ul className="flex gap-[6px] md:gap-3 gap-y-1 items-center nav-list-reset flex-1 justify-start flex-wrap">
                ...
                {/* Right Group */}
                <ul className="flex gap-[6px] md:gap-3 gap-y-1 items-center nav-list-reset flex-1 justify-end flex-wrap">
