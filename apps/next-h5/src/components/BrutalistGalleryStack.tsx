...
export default function BrutalistGalleryStack({ images }: BrutalistGalleryStackProps) {
    ...
    return (
        <div className="relative w-full aspect-[5/8] group">
            ...
            <button
                onClick={nextImage}
                className="absolute inset-0 z-10 flex items-end justify-end p-6 group/btn"
                aria-label="Next image"
            >
                {/* Brutalist Arrow Overlay - Bottom Right */}
                <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white border-4 border-black p-4 translate-x-4 group-hover:translate-x-0 transition-transform duration-300 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                    <svg
                        width="40"
                        height="40"
                        viewBox="0 0 24 24"
